                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
									...
									<form class="user" method="post" action="<?php echo base_url(); ?>index.php/register/proses">
										...
										<div class="form-group">
											<input type="text" class="form-control form-control-user" name="nama" id="nama" placeholder="nama pengguna">
										</div>
									...
									<hr>
                                    <div class="text-center">
                                        <a class="small" href="login">Halaman Masuk</a>
                                    </div>
                                </div>
                            </div>
                        </div>
